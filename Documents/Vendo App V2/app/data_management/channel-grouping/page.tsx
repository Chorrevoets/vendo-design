            ...
            >
                ...
                <div className="mb-6">
                    <nav className="flex items-center space-x-2 text-sm text-gray-600">
                        ...
                        <span className="text-gray-900 font-medium">Channel Grouping</span>
                    </nav>
                </div>
                ...
                <div className="space-y-6">
                    {showInfoPanel && (
                        <Card className="bg-white">
                            <CardHeader>
                                <CardTitle className="text-xl font-semibold text-gray-900">Organize Marketing Channels</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    <div className="lg:col-span-2 space-y-6">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-2">What are Channel Groupings?</h3>
                                            <p className="text-gray-600">
                                                Channel groupings are the integrations that let Vendo sync with your everyday platforms — like Google Ads, Facebook, Shopify, Mixpanel, and Google Analytics. By connecting them, you turn Vendo into your single source of truth.
                                            </p>
                                        </div>

                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900 mb-2">Why Organize?</h3>
                                ...
                                <div className="pt-4 flex justify-between items-center">
                                    <Button className="bg-black text-white hover:bg-gray-800">
                                        ...
                                        Add your first channel grouping
                                    </Button>
                                    <button
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-b border-gray-200">
                                            <th className="text-left py-3 px-4 font-semibold text-gray-900">Channel Grouping</th>
                                    ...
                                    <tbody>
                                        <tr className="border-b border-gray-100 hover:bg-gray-50 cursor-pointer" onClick={() => router.push('/data_management/channel-grouping/settings')}>
