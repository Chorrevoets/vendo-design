                                            ...
                                            <tbody className="divide-y divide-gray-200 bg-white">
                                                {filteredProperties.map(({ p }) => (
                                                    <tr key={p.id} className="hover:bg-gray-50">
                                                        ...
                                                        <td className="align-top px-3 py-4 text-sm text-gray-600">
                                                                        ...
                                                                        >
                                                                            {(p.description === "No description")
                                                                                ...
                                                                                : ((expandedById[p.id])
                                                                                    ...
                                                                                    : (((propDescriptionOverrideById[p.id] ?? p.description).length > 240)
                                                                                        ? (propDescriptionOverrideById[p.id] ?? p.description).slice(0, 240) + "…"
                                                                                        : (propDescriptionOverrideById[p.id] ?? p.description)))}
                                                                            {(p.description !== "No description") && ((propDescriptionOverrideById[p.id] ?? p.description).length > 240) && (
                                                                                <button
                                                                                    type="button"
                                                        ...
                                                        <td className="align-top whitespace-nowrap px-3 py-4 text-sm text-gray-500">{p.coverage}</td>
